...
public class Constants {
    public static final int TAB_RECEPTION_ID = 0;
    public static final int TAB_EXPEDITION_ID = 1;
    public static final int TAB_INVENTORY_ID = 2;
    public static final int TAB_SHUTTLE_ID = 3;
